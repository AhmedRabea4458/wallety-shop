...
class HomePage extends StatelessWidget {
  ...
  const HomePage({super.key, this.onNavigateToOperations});
                    ...
                    return BlocConsumer<ActiveShiftCubit, ActiveShiftState>(
                      listener: (context, shiftState) {
                        ...
                        if (shiftState is ActiveShiftLoaded) {
                          ...
                          context.read<DebtCubit>().loadShiftDebtActivity(
                      ...
                      builder: (context, shiftState) {
                        ...
                        if (operationState is OperationLoaded) {
                          ...
                          if (shiftState is ActiveShiftLoaded) {
                            ...
                            final shiftOps = operations.where(
                              (o) => o.shiftId == shiftId,
                            );
                            todayDeposits = shiftOps
                                .where(
                                  (o) =>
                                      o.operationType == OperationType.deposit,
                                )
                        ...
                        final adjustments =
                            adjustmentState is WalletAdjustmentLoaded
                                ? adjustmentState.adjustments
                                : <WalletAdjustmentEntity>[];

                        final totalWalletBalance = activeWallets.fold(
                          0.0,
                          (sum, w) => sum + w.balance,
                        );
                          ...
                          slivers: [
                              ...
                              builder: (context, debtState) {
                                ...
                                >(
                                  builder: (context, cashState) {
                                    ...
                                    >(
                                      builder: (context, instaPayState) {
                                        final instaPayAccounts =
                                            instaPayState
                                                    is InstaPayAccountLoaded
                                                ? instaPayState.accounts
                                                : const <
                                    ...
                                    SizedBox(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          ...
                                          final usage =
                                              WalletLimitCalculator.calculate(
                                                wallet: wallet,
                            ...
                            SliverToBoxAdapter(
                              child: OperationList(
                                ...
                                wallets: wallets,
                                operationDebts:
                                    operationState is OperationLoaded
                                        ? operationState.operationDebts
                                        : {},
