        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.border45, width: 1),
            ),
            child: Column(
              children:
                  operations.isEmpty
                      ...
                      : operations.take(5).map((operation) {
                        ...
                        final typeColor = _getOperationTypeColor(
                          operation.operationType,
                        );
                        final typeIcon = _getOperationTypeIcon(
                          operation.operationType,
                        );
                        ...
                        return Column(
                          children: [
                            ...
                            TransactionRow(
                              ...
                              onTap: () {
                                final hasDebt = operationDebts.containsKey(
                                  operation.id,
                                );
                                if (hasDebt) {
                                  context.push(
