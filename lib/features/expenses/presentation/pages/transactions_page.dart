...
class TransactionsPage extends StatelessWidget {
                          ...
                          child: Row(
                            children: [
                              ...
                              _buildFilterChip(
                                label: 'سحب',
                                isActive:
                                    selectedType == OperationType.withdrawal,
                                onTap:
                                    () => context
                                        .read<OperationCubit>()
                                        .filterByOperationType(
                          ...
                          child: Row(
                            children: [
                              ...
                              _buildFilterChip(
                                label: 'InstaPay',
                                isActive:
                                    selectedProvider == ProviderType.instaPay,
                                onTap:
                                    () => context
                                        .read<OperationCubit>()
                                        .filterByProvider(
  ...
  Widget _buildFilterChip({
    ...
    return Padding(
      ...
      child: FilterChipWidget(label: label, isActive: isActive, onTap: onTap),
    );
  }
}
            ...
            return Column(
              ...
              children: [
                ...
                ...group.operations.map((operation) {
                  final typeColor = TransactionsPage._getOperationTypeColor(
                    operation.operationType,
                  );
                  final typeIcon = TransactionsPage._getOperationTypeIcon(
                    operation.operationType,
                  );
                  final typeLabel = TransactionsPage._getOperationTypeLabel(
                    operation.operationType,
                  );
                  final walletName =
                      wallets
                  ...
                  final title =
                      operation.notes?.trim().isNotEmpty == true
                          ? operation.notes!
                        ...
                        Dismissible(
                          ...
                          child: Container(
                            ...
                            child: TransactionRow(
                              ...
                              date: DateFormatter.formatTransactionDate(
                                operation.createdAt,
                              ),
                              amount:
